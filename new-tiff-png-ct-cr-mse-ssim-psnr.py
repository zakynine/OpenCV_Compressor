...
def main():
    ...
    # quality level 0 - 9 means lower better quality.

    outpath_png = "compressed_image.png"
    quality_level = 3            # 2 png == 8 jpg :: 4 png == 6 jpg :: 6 png == 4 jpg :: 8 png == 2 jpg
    save(outpath_png,img,png_compression=quality_level)
    ...
    new_image_size = os.path.getsize(outpath_png)
